        ...
        <div className="armeniagov-header__logo">
          <a href={homeHref} className="armeniagov-header__link armeniagov-header__link--homepage">
            <span className="armeniagov-header__logotype">
              <svg aria-hidden="true" focusable="false" className="armeniagov-header__logotype-crown" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 132 97" height="30" width="36">
                ...
                <ul className="armeniagov-header__navigation-list">
                  {
                    props.navigation.map(item => (
                      <li className={`armeniagov-header__navigation-item ${item === activeNav ? 'armeniagov-header__navigation-item--active' : ''}`}>
                        <a
